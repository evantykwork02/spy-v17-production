...
| --- | --- | --- | --- | --- | --- |
| SPY buy-and-hold | 1147.2% | 15.58% | 0.883 | -33.7% | 0.462 |
| V12 (defensive engine) | 3204.8% | 22.22% | 1.198 | -24.2% | 0.920 |
| **V17 Conservative** | **3836.2%** | **23.45%** | **1.216** | **-24.2%** | **0.967** |

**V17 outperformed SPY by +2689.0% in total return, with Sharpe +0.333 higher and max drawdown +9.5% (less negative is better).**
...
| Model | Total return | CAGR | Sharpe | Max drawdown | Calmar |
| --- | --- | --- | --- | --- | --- |
| SPY buy-and-hold | 111.8% | 15.13% | 0.917 | -24.5% | 0.617 |
| V12 | 221.3% | 24.48% | 1.431 | -16.9% | 1.445 |
| V17 Conservative | 238.1% | 25.68% | 1.439 | -17.1% | 1.500 |
...
| --- | --- | --- | --- | --- | --- |
| vs V12 | full | total_return | +631.4% | 0.0000 | highly significant (p<0.01) |
...
| vs V12 | holdout_2021_plus | max_drawdown | -0.2% | 0.8650 | not significant |
| vs SPY | full | total_return | +2689.0% | 0.0000 | highly significant (p<0.01) |
...
| vs SPY | holdout_2021_plus | total_return | +126.2% | 0.0150 | significant (p<0.05) |
