...
| ---------------- | ---------- | ----------------- | ------------ | -------------- | ------ | -------------------- | ----------- | --------- |
| v17_conservative | v12        | full              | total_return | 8.0486         | 0.0000 | 10.7206              | 2000        | 21        |
| v17_conservative | v12        | full              | sharpe       | 0.0237         | 0.0765 | 0.0234               | 2000        | 21        |
| v17_conservative | v12        | full              | calmar       | 0.0601         | 0.1605 | 0.0305               | 2000        | 21        |
| v17_conservative | v12        | full              | max_drawdown | -0.0008        | 0.8795 | -0.0079              | 2000        | 21        |
| v17_conservative | v12        | holdout_2021_plus | total_return | 0.2318         | 0.0270 | 0.2565               | 2000        | 21        |
| v17_conservative | v12        | holdout_2021_plus | sharpe       | 0.0093         | 0.3560 | 0.0105               | 2000        | 21        |
| v17_conservative | v12        | holdout_2021_plus | calmar       | 0.0687         | 0.4675 | 0.0088               | 2000        | 21        |
| v17_conservative | v12        | holdout_2021_plus | max_drawdown | -0.0031        | 0.9700 | -0.0108              | 2000        | 21        |
| v17_conservative | SPY_BH     | full              | total_return | 28.6762        | 0.0000 | 36.7482              | 2000        | 21        |
| v17_conservative | SPY_BH     | full              | sharpe       | 0.3374         | 0.0000 | 0.3371               | 2000        | 21        |
| v17_conservative | SPY_BH     | full              | calmar       | 0.5173         | 0.0045 | 0.3973               | 2000        | 21        |
| v17_conservative | SPY_BH     | full              | max_drawdown | 0.0947         | 0.1510 | 0.0558               | 2000        | 21        |
| v17_conservative | SPY_BH     | holdout_2021_plus | total_return | 1.3287         | 0.0155 | 1.4210               | 2000        | 21        |
| v17_conservative | SPY_BH     | holdout_2021_plus | sharpe       | 0.5137         | 0.0245 | 0.5033               | 2000        | 21        |
| v17_conservative | SPY_BH     | holdout_2021_plus | calmar       | 0.8937         | 0.0480 | 0.7773               | 2000        | 21        |
| v17_conservative | SPY_BH     | holdout_2021_plus | max_drawdown | 0.0724         | 0.2390 | 0.0385               | 2000        | 21        |

## 2. Random rebalance timing test

| metric       | actual  | random_mean | random_p95 | p_random_beats_actual | n_random |
| ------------ | ------- | ----------- | ---------- | --------------------- | -------- |
| total_return | 40.1790 | 11.3680     | 17.8700    | 0.0000                | 1000     |
| sharpe       | 1.1446  | 0.7211      | 0.8484     | 0.0000                | 1000     |
| calmar       | 0.9792  | 0.4127      | 0.5356     | 0.0000                | 1000     |
| max_drawdown | -0.2425 | -0.3745     | -0.3143    | 0.0000                | 1000     |
...
| ------------ | ---------------------------- | --------------- | -------------- | -------------------------- | ----------- |
| total_return | 28.6762                      | 3.7024          | 13.3721        | 0.0200                     | 100         |
| sharpe       | 0.3374                       | -0.0351         | 0.0699         | 0.0000                     | 100         |
| calmar       | 0.5173                       | -0.0583         | 0.0837         | 0.0000                     | 100         |
| max_drawdown | 0.0947                       | -0.0501         | 0.0076         | 0.0000                     | 100         |
...
| NORMAL          | 728  | -0.0707          | -0.0695          | -0.0638          | -0.2194    | -0.2184    | -0.2037    | -0.0003                                    | 0.4940                    |
...
| ---------------- | ----- | ----------- | ---------- | ---------- | ---------- | ---------------- | ------------------ | ------------------ |
| SPY_BH           | 20000 | 0.8055      | 0.4142     | 0.8067     | 1.1997     | 0.9998           |                    |                    |
| v12              | 20000 | 1.1186      | 0.7236     | 1.1188     | 1.5138     | 1.0000           |                    |                    |
| v17_conservative | 20000 | 1.1431      | 0.7425     | 1.1428     | 1.5399     | 1.0000           | 0.8371             | 0.5285             |
...
| test                     | pct_variants_true | n_variants |
| ------------------------ | ----------------- | ---------- |
| beats_v12_holdout_return | 1.0000            | 216        |
| beats_v12_holdout_sharpe | 0.6667            | 216        |
| beats_v12_holdout_calmar | 1.0000            | 216        |
| beats_v12_holdout_maxdd  | 0.0000            | 216        |
